...
@yield('preloader')
  ...
  <nav class="main-header navbar navbar-expand navbar-primary navbar-dark border-bottom-0">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://wa.me/6281586557363" class="nav-link" target="_blank">Contact Whatsapp</a>
      </li>
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/index" class="brand-link">
      <img src={{ asset('img/logoutamabg.png') }} alt="Vinoch.id Logo" class="brand-image img-circle elevation-3">
      <span class="brand-text font-weight-light">Vinoch.id</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item ">
            <a href="{{ route('userpembeli') }}" class="nav-link {{ request()->is('userpembeli','createuserpembeli') ? 'active' : '' }}">
            ...
            <li class="nav-item ">
                <a href="{{ route('produk') }}" class="nav-link {{ request()->is('produk','createproduk') ? 'active' : '' }}">
            ...
            <li class="nav-item ">
                <a href="{{ route('pemesanan') }}" class="nav-link {{ request()->is('pemesanan') ? 'active' : '' }}">
            ...
            <li class="nav-item ">
                <a href="{{ route('user') }}" class="nav-link {{ request()->is('user','create',) ? 'active' : '' }}">
  ...
  <footer class="main-footer">
    <strong>Made With &hearts; by <a href="https://www.instagram.com/vinonlr/" target="_blank" >Vinoch.Id</a>.</strong>

    <div class="float-right d-none d-sm-inline-block">
      <b>Version</b> *Under Development
    </div>
  </footer>
